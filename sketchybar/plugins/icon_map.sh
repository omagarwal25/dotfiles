...
# Local overrides — checked BEFORE the upstream icon_map. Anything outside the
# START-OF-ICON-MAP / END-OF-ICON-MAP markers survives regeneration from
# https://github.com/kvndrsslr/sketchybar-app-font releases.
function __icon_map_local() {
    case "$1" in
